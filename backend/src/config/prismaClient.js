 ...
 * 
 * @database-location
 * Default: `backend/prisma/rotator.db`
 * 
 * Path resolution priority:
 * 1. DATABASE_URL environment variable
 * 2. Relative paths converted to absolute
 * 3. Default: backend/prisma/rotator.db
 * 
 * @usage
 * ```javascript
 ...
 * - Not set → Uses default backend/prisma/rotator.db
 * 
 * @startup-diagnostics
 ...
 * - DATABASE_URL: SQLite database path (default: file:backend/prisma/rotator.db)
...
// Resolver ruta absoluta desde backend/src/config/
